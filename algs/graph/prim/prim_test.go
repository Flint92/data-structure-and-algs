...
func TestPrim(t *testing.T) {
	...
	require.Equal(t, &Edge{src: "C", dst: "F", weight: 4.0}, edges[1])
	require.Equal(t, &Edge{src: "F", dst: "D", weight: 2.0}, edges[2])
	require.Equal(t, &Edge{src: "C", dst: "B", weight: 5.0}, edges[3])
	require.Equal(t, &Edge{src: "B", dst: "E", weight: 3.0}, edges[4])
